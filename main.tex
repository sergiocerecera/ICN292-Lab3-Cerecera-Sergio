...
A continuación se presentan capturas del historial de ejecuciones de los workflows implementados en n8n. Estas evidencias permiten verificar que los workflows se ejecutaron correctamente y que los nodos del proceso completaron sus respectivas tareas.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ejecucion_resumen.png}
    \caption{Ejecución exitosa del workflow LAB - Resumen Diario.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ejecucion_webhook.png}
    \caption{Ejecución exitosa del workflow LAB - Prueba Webhook.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ejecucion_envio.png}
    \caption{Ejecución exitosa del workflow LAB - Enviar Solicitud.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{ejecucion_fallida.png}
    \caption{Ejecución fallida del workflow LAB - Prueba Webhook por dirección de correo inválida.}
\end{figure}
\end{document}